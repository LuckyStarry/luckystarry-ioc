...
import index, { AddSingleton, AddTransient, Default, GetService, ServiceCollection, Injectable } from '../src/index'
...
describe('Index', function () {
  ...
  it('存在 Injectable', function () {
    expect(Injectable).not.null
    expect(Injectable).not.undefined
